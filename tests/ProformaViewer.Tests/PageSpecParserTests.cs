using Xunit;using ProformaViewer.Services;
...
public class PageSpecParserTests
{
 ...
 [Theory][InlineData("")][InlineData("0")][InlineData("abc")][InlineData("2x0")]
 public void RejectsInvalidFormats(string value)=>Assert.Throws<FormatException>(()=>PageSpecParser.Parse(value));
}
